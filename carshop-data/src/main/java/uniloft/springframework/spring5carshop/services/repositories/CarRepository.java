...
public interface CarRepository extends CrudRepository<Car, Long> {
    ...
    @Query(nativeQuery = true, value="SELECT * FROM Car INNER JOIN CAR_TYPE ON CAR_TYPE.id = CAR.car_type_id WHERE CAR_TYPE.type_name IN (:carType) AND Car.price BETWEEN :minPrice AND :maxPrice")
    Set<Car> findCarsByCarType_TypeName(List<String> carType, BigDecimal minPrice, BigDecimal maxPrice);

    @Query(nativeQuery = true, value="SELECT * FROM Car INNER JOIN CAR_TYPE ON CAR_TYPE.id = CAR.car_type_id INNER JOIN ENGINE ON ENGINE.id = CAR.engine_id WHERE CAR_TYPE.type_name IN (:carType) AND ENGINE.type IN (:engineType) AND Car.price BETWEEN :minPrice AND :maxPrice")
    ...
    @Query(nativeQuery = true, value="SELECT * FROM Car INNER JOIN CAR_TYPE ON CAR_TYPE.id = CAR.car_type_id INNER JOIN CAR_BRAND ON CAR_BRAND.id = CAR.brand_id WHERE CAR_TYPE.type_name IN (:carType) AND CAR_BRAND.brand_name IN (:brandName) AND Car.price BETWEEN :minPrice AND :maxPrice")
    ...
    @Query(nativeQuery = true, value="SELECT * FROM Car INNER JOIN CAR_TYPE ON CAR_TYPE.id = CAR.car_type_id INNER JOIN CAR_MODEL ON CAR_MODEL.id = CAR.model_id WHERE CAR_TYPE.type_name IN (:carType) AND CAR_MODEL.model_name IN (:modelName) AND Car.price BETWEEN :minPrice AND :maxPrice")
    ...
    @Query(nativeQuery = true, value="SELECT * FROM Car INNER JOIN CAR_TYPE ON CAR_TYPE.id = CAR.car_type_id INNER JOIN CAR_BODY ON CAR_BODY.id = CAR.body_id WHERE CAR_TYPE.type_name IN (:carType) AND CAR_BODY.body_name IN (:bodyName) AND Car.price BETWEEN :minPrice AND :maxPrice")
    ...
    @Query(nativeQuery = true, value="SELECT * FROM Car INNER JOIN CAR_TYPE ON CAR_TYPE.id = CAR.car_type_id INNER JOIN CAR_BRAND ON CAR_BRAND.id = CAR.brand_id INNER JOIN CAR_MODEL ON CAR_MODEL.id = Car.model_id WHERE CAR_TYPE.type_name IN (:carType) AND CAR_BRAND.brand_name IN (:brandName) AND CAR_MODEL.model_name IN (:modelName) AND Car.price BETWEEN :minPrice AND :maxPrice")
    ...
    @Query(nativeQuery = true, value="SELECT * FROM Car INNER JOIN CAR_TYPE ON CAR_TYPE.id = CAR.car_type_id INNER JOIN CAR_BRAND ON CAR_BRAND.id = CAR.brand_id INNER JOIN CAR_BODY ON CAR_BODY.id = Car.body_id WHERE CAR_TYPE.type_name IN (:carType) AND CAR_BRAND.brand_name IN (:brandName) AND CAR_BODY.body_name IN (:bodyName) AND Car.price BETWEEN :minPrice AND :maxPrice")
    ...
    @Query(nativeQuery = true, value="SELECT * FROM Car INNER JOIN CAR_TYPE ON CAR_TYPE.id = CAR.car_type_id INNER JOIN CAR_MODEL ON CAR_MODEL.id = CAR.model_id INNER JOIN CAR_BODY ON CAR_BODY.id = Car.body_id WHERE CAR_TYPE.type_name IN (:carType) AND CAR_MODEl.model_name IN (:modelName) AND CAR_BODY.body_name IN (:bodyName) AND Car.price BETWEEN :minPrice AND :maxPrice")
    ...
    @Query(nativeQuery = true, value="SELECT * FROM Car INNER JOIN CAR_TYPE ON CAR_TYPE.id = CAR.car_type_id INNER JOIN CAR_BRAND ON CAR_BRAND.id = CAR.brand_id INNER JOIN CAR_MODEL ON CAR_MODEL.id = Car.model_id INNER JOIN CAR_BODY ON CAR_BODY.id = Car.body_id WHERE CAR_TYPE.type_name IN (:carType) AND CAR_BRAND.brand_name IN (:brandName) AND CAR_MODEL.model_name IN (:modelName) AND CAR_BODY.body_name IN (:bodyName) AND Car.price BETWEEN :minPrice AND :maxPrice")
